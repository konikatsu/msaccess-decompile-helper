...
最新版は [GitHub Releases](https://github.com/konikatsu/msaccess-decompile-helper/releases) からダウンロードできます。

使いたいバージョンの `Assets` から `msaccess-decompile-helper-vX.Y.Z.zip` をダウンロードしてください。
...
1. [リリース一覧](https://github.com/konikatsu/msaccess-decompile-helper/releases) を開き、最新版または使いたいバージョンの `Assets` から `msaccess-decompile-helper-vX.Y.Z.zip` をダウンロードします。
