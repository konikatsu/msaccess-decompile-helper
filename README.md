...
[リリースページを開く](https://github.com/konikatsu/msaccess-decompile-helper/releases/latest)

リリースページの `Assets` から `msaccess-decompile-helper.zip` をダウンロードしてください。
...
1. [リリースページ](https://github.com/konikatsu/msaccess-decompile-helper/releases/latest) を開き、`Assets` から `msaccess-decompile-helper.zip` をダウンロードします。
